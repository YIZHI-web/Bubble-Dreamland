...
namespace GabrielBissonnette.Primo
{
    public class MainMenuManager : MonoBehaviour
    {
        ...
        [Space(10)]
        [SerializeField] ButtonData[] customButtons;
        ...
        public void UIEditorUpdate()
        {
            ...
            if (customButtons != null)
            {
                ...
                {
                    if (customButtons[i].buttonImage != null && customButtons[i].buttonSprite != null)
                    {
                        customButtons[i].buttonImage.sprite = customButtons[i].buttonSprite;
                    }
                }
            }
